    ...
    if (!$busca) {
        ...
        while ($array = mysqli_fetch_array($busca)) {
            ...
            mysqli_query($conexao, $sql2) or die("Erro ao excluir o registro (2). " . mysqli_error($conexao));

            $sql4 = "DELETE FROM tblcontatos WHERE idcontatos = $idcontatos ";

            mysqli_query($conexao, $sql4) or die("Erro ao excluir o registro (3). " . mysqli_error($conexao));
            echo "Registro excluido com sucesso!";
            exit;
